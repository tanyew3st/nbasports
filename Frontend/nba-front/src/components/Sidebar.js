...
const Sidebar = (props) => {
    ...
    return <Fragment> 
        <div className="bg-gray-800 h-full pt-10 pl-5 overflow-y-none">
            <div>
               <Link to="/home"><button className={`text-xl mb-3 hover:text-gray-300 ${currentState === "Home" ? "text-green-400" : "text-white" }`}
                onClick={() => {
            ...
            <div className="mt-96">
                <Link to="/login"><button onClick={() => setCurrentState("Login")} className={`text-xl mb-3 ${currentState === "login" || currentState === "signup" ? "text-green-400" : "text-gray-300" }`}>
